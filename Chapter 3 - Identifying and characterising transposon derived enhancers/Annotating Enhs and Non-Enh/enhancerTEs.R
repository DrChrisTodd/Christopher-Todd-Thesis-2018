...
#RefSeq TSS lookup
RefSeq = read.delim('Data/Annotations/RefSeq_mRNA.txt')
...
es.k4me1 = read.delim('Data/ChIP_peaks/ES_H3K4me1_peaks.broadPeak',as.is=T,header=F)
...
es.dhs = read.delim('Data/DNase_peaks/ES_ATAC_peaks.npf',as.is=T,header=F)

ts.k4me1 = read.delim('Data/ChIP_peaks/TS_H3K4me1_peaks.broadPeak',as.is=T,header=F)
...
ts.dhs = read.delim('Data/DNase_peaks/TS_ATAC_peaks.npf',as.is=T,header=F)
